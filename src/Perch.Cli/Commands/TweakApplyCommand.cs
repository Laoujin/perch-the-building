...
public sealed class TweakApplyCommand : AsyncCommand<TweakApplyCommand.Settings>
{
    ...
    public TweakApplyCommand(ICatalogService catalog, ITweakService tweakService, IAnsiConsole console)
    {
        _catalog = catalog;
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings, CancellationToken cancellationToken)
    {
        ...
        var result = _tweakService.Apply(tweak, settings.DryRun);
