        ...
        foreach (string subdir in subdirectories)
        {
            ...
            try
            {
                ...
                if (parseResult.IsSuccess)
                {
                    ...
                    modules.Add(new AppModule(manifest.ModuleName, manifest.DisplayName, manifest.Enabled, subdir, manifest.Platforms, manifest.Links, manifest.Hooks, manifest.CleanFilter, manifest.Registry, manifest.GlobalPackages, manifest.VscodeExtensions, manifest.PsModules, manifest.PathEntries, manifest.Install));
                }
                else
                {
